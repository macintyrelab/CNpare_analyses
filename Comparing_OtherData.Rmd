...
Gene positions were downloaded from UCSC Table Browser. We extracted the copy numbers in the transcription start of 27,212 protein-coding genes, and then compared gene-level copy numbers across cell lines using Pearson correlation.
```{r}
#gene positions
...
colnames(correlations)[3]<-"r" #Needed by getTopHit function (will be updated soon)
